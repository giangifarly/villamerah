	...
	<div class="container">
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo site_url('siswa/fsrd5') ?>">Arsir</a></li>
						...
						<div class="box box-default">
							...
							<div class="box-body">
								<ul class="list-unstyled">
									<li><a href="<?php echo site_url('siswa/volume') ?>">Arsir Volume</a></li>
									<li><a href="<?php echo site_url('siswa/dimensi') ?>">Arsir Dimensi</a></li>
									<li><a href="<?php echo site_url('siswa/material') ?>">Arsir Material</a></li>
									<li><a href="<?php echo site_url('siswa/cahaya') ?>">Arsir Cahaya</a></li>
								</ul>
							</div>
							<!-- /.box-body -->
						</div>
