					...
					<div class="nav-tabs-custom">
						...
						<div class="tab-content">
							...
							<div class="tab-pane active" id="tab_3">
								<video controls width="100%" controlsList="nodownload"><source src="<?php echo base_url('assets/videos/perspektif/membuat-lampu-tepat-diatas-meja.mp4') ?>" type="video/mp4">
								</video>
							</div>
							<!-- /.tab-pane -->
						</div>
