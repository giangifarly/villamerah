					...
					<div class="nav-tabs-custom">
						...
						<div class="tab-content">
							...
							<div class="tab-pane active" id="tab_2">
								<img src="<?php echo base_url('assets/images/18_konstruksi_tabung.png') ?>" width="100%">
								<img src="<?php echo base_url('assets/images/11_struktur bentuk_tabung.png') ?>" width="100%">
							</div>
							<!-- /.tab-pane -->
