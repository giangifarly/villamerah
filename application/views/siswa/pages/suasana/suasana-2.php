	...
	<div class="container">
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo site_url('siswa/fsrd10') ?>">Gambar Suasana</a></li>
						...
						<div class="box box-default">
							...
							<div class="box-body">
								<ul class="list-unstyled">
									<li><a href="<?php echo site_url('siswa/sederhana') ?>">Gambar Suasana Sederhana</a></li>
									<li><a href="<?php echo site_url('siswa/imajinasi') ?>">Gambar Suasana Imajinasi</a></li>
								</ul>
							</div>
							<!-- /.box-body -->
						</div>
